...
public interface ITesteeRequestRepository
{
  ...
  void denyTesteeRequest (UUID sessionKey, long proctorKey, UUID browserKey, UUID requestKey, String reason) throws ReturnStatusException;
